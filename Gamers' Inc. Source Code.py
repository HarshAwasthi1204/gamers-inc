...
cursor=conn.cursor()
cursor.execute ("CREATE table IF NOT EXISTS Accounts ( Acct_ID int primary key , Full_Name varchar(50) , Age int, Gender varchar(7), Date_Of_Birth date, Email_ID varchar(30), Username varchar(50), Password varchar(50), Location varchar(20), Balance numeric, Status varchar(50), Profile_Picture  varchar(1000))")
...
initial_data_query="INSERT INTO Accounts(Acct_ID,Full_Name,Age,Gender,Date_Of_Birth,Email_ID,Username,Password,Location,Balance,Status,Profile_Picture) VALUES(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
if count0 == 1 and count1 == 0:
    initial_data=[(1, 'Hank Stark', 17, 'Male', '2003-04-12', 'hankstark1204@gmail.com', 'HankStark1204','code&chill1204','India',10000,"In this era of CAPTCHAs, prove you're humane!","Media/images (9).jpg"),
                  (2, 'Tony Williamson', 16, 'Male', '2004-07-05', 'tony2004@gmail.com', 'TonyW24','ilovegaming2004','USA',3000,"Plannin' a Video Game Party Night, Wanna join??","Media/images (8).jpg"),
                  (3, 'Anne Dorrance', 17, 'Female', '2003-05-15', 'anned15@gmail.com', 'AnneDorr15','gameon?15','Australia',5000,"Be the reason someone smiles today!","Media/images.jpg"),
                  (4, 'Caroline Starr', 16, 'Female', '2004-10-22', 'carols2204@gmail.com', 'CarolStarr2204','gamingislife22','Germany',4000,"Gamer 4 Life!","Media/image.jpg")]
...
def Home_Page():
    ...
    abt.place(x=714,y=0,width=120,height=52)
    ...
    for btn in [home,nu,browse,abt,login_btn]:
    ...
    def create_account_page():
        ...
        def create_account():
            ...
            if age_error ==  False and dob_error == False and emailid_error == False and usrnm_error == False and pswd_error == False and checktcsval == 1:
                ...
                details=(acct_id,full_name,ageval,gender,dobval,emailidval,usrnmval,pswdval,location,bal,stat,dp_file)
...
def Inventory_Pages():
    ...
    def Inventory_Page_1():
        ...
        login_btn=tek.Button(master=frame1,text=username,bg="Sky Blue",fg="Yellow",font=('Battlelines',15,'bold'),cursor="hand2",bd=0,activebackground='green',anchor="w",activeforeground='orange',command=show_profile_page)
        login_btn.place(relx=1.0,y=0,width=250,height=52,anchor="ne")
        pp=tek.Label(frame1,image=Img1)
        pp.place(relx=1.0,y=0,anchor="ne")
